...
<section class="display-order">
    ...
    ?>
    <div class="grand-total"> Your Total : <span>$<?php echo $grand_total; ?></span></div>
</section>
...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <h3>Let's check out your order</h3>
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>City:</span>
                <input type="text" name="city" placeholder="e.g. Marikina">
            </div>
            <div class="inputBox">
                <span>State:</span>
                <input type="text" name="state" placeholder="e.g. Manila">
            </div>
            <div class="inputBox">
                <span>Country:</span>
            ...
            <div class="inputBox">
                ...
                <input type="number" min="0" name="pin_code" placeholder="e.g. 4109">
            </div>
        </div>
