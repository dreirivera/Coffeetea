...
<section class="heading">
    <h3>shopping cart</h3>
    <p> <a href="wishlist.php">WISHLIST</a> / CART </p>
</section>

<section class="shopping-cart">

    <h1 class="title">INSIDE YOUR CART</h1>
    ...
    <div  class="box">
        ...
        <form action="" method="post">
            ...
            <input type="submit" value="UPDATE QUANTITY" class="option-btn" name="update_quantity">
        </form>
